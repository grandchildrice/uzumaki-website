...
const activities = [
  {
    ...
    description:
      "Hosted a workshop on zkVM advancements with leading researchers.",
  },
  {
    date: "2023-05-15",
    title: "Published Research Paper",
    description:
      "Our paper on 'Optimizing Ethereum Consensus Mechanisms' was published in a peer-reviewed journal.",
  },
  {
    date: "2023-04-20",
    title: "Collaboration Announcement",
    description:
      "Announced a new collaboration with XYZ University on client-side zk proving research.",
  },
  {
    date: "2023-03-10",
    title: "Conference Presentation",
    description:
      "Presented our findings on incentive mechanisms at the International Blockchain Conference.",
  },
];
